        ...
        <header className='bg-white border-gray-200 white:bg-gray-900 fixed w-full border-b'>
            <div className='max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4'> {/*contenedor padre*/}
                ...
                <div>
                    ...
                    <button className='focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'>Registrarse</button>
                </div>
            </div>
        </header>
    )
